...
router.post('/', validateBody(postSchema), ctrlWrapper(createTaskController));
router.patch('/:taskId', isValidId, validateBody(patchSchema), ctrlWrapper(updateByIdController));
router.patch('/:taskId/archive', isValidId, ctrlWrapper(archivedTaskController));
router.delete('/:taskId', isValidId, ctrlWrapper(deleteByIdController));
